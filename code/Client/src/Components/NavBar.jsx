...
const NavBar = () => {
  ...
  return (
    <div className="w-full bg-white shadow-md fixed top-0 z-50">
      ...
      {/* Top Section */}
      <div className="flex items-center justify-between px-8 py-2 bg-blue-50">
      ...
      <nav className="flex justify-center items-center gap-10 py-3 bg-white text-gray-700 font-medium">
        ...
        <Link to="home" smooth={true} duration={500} offset={-80} onClick={scrollToTop} className="cursor-pointer hover:text-blue-500 transition">
          Home
        </Link>

        <Link to="temples" smooth={true} duration={500} offset={-120} className="cursor-pointer hover:text-blue-500 transition">
          Temples
        </Link>

        <Link to="about" smooth={true} duration={500} offset={-140} className="cursor-pointer hover:text-blue-500 transition">
          About
        </Link>

        <Link to="services" smooth={true} duration={500} offset={-140} className="cursor-pointer hover:text-blue-500 transition">
          Services
        </Link>

        <Link to="contact" smooth={true} duration={500} offset={-100} className="cursor-pointer hover:text-blue-500 transition">
          Contact Us
        </Link>
